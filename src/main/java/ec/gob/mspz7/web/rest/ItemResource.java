...
/**
 * REST controller for managing {@link ec.gob.mspz7.domain.Item}.
 */
@RestController
...
public class ItemResource {
    ...
    public ResponseEntity<List<ItemDTO>> getAllItems(
        ...
        if ("pais-is-null".equals(filter)) {
            log.debug("REST request to get all Items where pais is null");
            return new ResponseEntity<>(itemService.findAllWherePaisIsNull(), HttpStatus.OK);
        }
