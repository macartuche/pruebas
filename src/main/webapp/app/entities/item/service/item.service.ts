...
export class ItemService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/items/_search');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    ...
    return this.http
      ...
      .pipe(catchError(() => scheduled([new HttpResponse<IItem[]>()], asapScheduler)));
  }
