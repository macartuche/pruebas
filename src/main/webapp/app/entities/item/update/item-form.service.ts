...
type ItemFormGroupContent = {
  ...
  codigo: FormControl<IItem['codigo']>;
  codigoCatalogo: FormControl<IItem['codigoCatalogo']>;
  descripcion: FormControl<IItem['descripcion']>;
  catalogo: FormControl<IItem['catalogo']>;
};
...
export class ItemFormService {
  createItemFormGroup(item: ItemFormGroupInput = { id: null }): ItemFormGroup {
    ...
    return new FormGroup<ItemFormGroupContent>({
      ...
      codigo: new FormControl(itemRawValue.codigo, {
        validators: [Validators.required],
      }),
      codigoCatalogo: new FormControl(itemRawValue.codigoCatalogo, {
        validators: [Validators.required],
      }),
      descripcion: new FormControl(itemRawValue.descripcion),
      catalogo: new FormControl(itemRawValue.catalogo),
    });
  }
